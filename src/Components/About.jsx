...
const About = () => {
    return (
        <div name="about" className='About'>
            ...
            <p>
                I’ve been studying in the third year of the bachelor's degree program at the NRU MPEI with the degree in 09.03.01 "Computer Science and Computer Engineering". 
